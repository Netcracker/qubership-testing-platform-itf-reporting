...
### To support such testing process, ITF provides functionality
...
![Use case #1 schema](docs/images/use_case_1.png)
...
![Use case #2 schema](docs/images/use_case_2.png)
...
![High Level Architecture Schema](docs/images/high_level_architecture.png)
